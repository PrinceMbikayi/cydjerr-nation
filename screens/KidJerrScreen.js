...
const KidJerrScreen = () => {
  ...
  const renderTabNavigation = () => (
    <BlurView intensity={20} style={styles.tabContainer}>
      <ScrollView
        horizontal
  ...
  const renderMissionStatement = () => (
    <BlurView intensity={10} style={styles.missionCard}>
  ...
  const renderUrgentProjects = () => (
    <View style={styles.urgentSection}>
      ...
      {urgentProjects.map((project) => (
        <BlurView key={project.id} intensity={10} style={styles.projectCard}>
