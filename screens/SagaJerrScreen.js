...
const SagaJerrScreen = ({ navigation }) => {
  ...
  const PostCard = ({ post }) => (
    <BlurView intensity={20} tint="light" style={styles.postCard}>
  ...
  const ActionSheet = () => (
    ...
    >
      <View style={styles.actionSheetOverlay}>
        ...
        />
        <BlurView intensity={40} tint="dark" style={styles.actionSheetContainer}>
  ...
  return (
    <LinearGradient colors={['#8A2D6C', '#1D7CA6']} style={styles.container}>
      ...
      >
        ...
        <BlurView intensity={20} tint="light" style={styles.newPostContainer}>
