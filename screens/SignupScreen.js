          ...
          >
            ...
            <View style={styles.profileContainer}>
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <BlurView intensity={20} style={styles.profileImageBlur}>
                  {profileImage ? (
                ...
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <BlurView intensity={20} style={styles.cameraButtonBlur}>
                    <MaterialCommunityIcons
                      name="camera"
                      size={16}
                      color="#FFFFFF"
            ...
            <View style={styles.socialContainer}>
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <BlurView intensity={15} style={styles.socialButtonBlur}>
                  <MaterialCommunityIcons
                    name="google"
                    size={24}
                    color="#FFFFFF"
