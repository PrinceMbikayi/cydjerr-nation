...
const GameJerrScreen = () => {
  ...
  const HeroSection = () => (
    <BlurView intensity={20} style={styles.heroSection}>
      <LinearGradient
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <TouchableOpacity style={[
            ...
            <BlurView intensity={15} style={styles.gameCardBlur}>
      ...
      <FlatList
        ...
        renderItem={({ item, index }) => (
          <TouchableOpacity style={[
            ...
            <BlurView intensity={15} style={styles.streamCardBlur}>
    ...
    <View style={styles.trendingSection}>
      ...
      {mockTrendingTopics.map((topic) => (
        <TouchableOpacity key={topic.id} style={styles.trendingItem}>
          <BlurView intensity={10} style={styles.trendingItemBlur}>
