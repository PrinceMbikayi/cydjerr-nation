...
const ShopJerrScreen = ({ navigation }) => {
  ...
  const renderFlashDealCard = (deal) => {
    ...
    return (
      ...
      >
        <BlurView intensity={20} style={styles.dealCardBlur}>
  ...
  const renderNewProductCard = (product) => {
    ...
    return (
      ...
      >
        <BlurView intensity={15} style={styles.productCardBlur}>
  ...
  const renderRecommendationCard = (item) => {
    ...
    return (
      <TouchableOpacity
        ...
        onPress={() => animatePress()}
      >
        <BlurView intensity={15} style={styles.recoCardBlur}>
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroSection}>
          <BlurView intensity={15} style={styles.heroContainer}>
            <Image
        ...
        <View style={styles.recommendationsSection}>
          ...
          <View style={styles.recommendationsContainer}>
            ...
            <BlurView intensity={15} style={styles.algoCard}>
      ...
      {cartItems > 0 && (
        <TouchableOpacity style={styles.floatingCart}>
          <BlurView intensity={30} style={styles.floatingCartBlur}>
