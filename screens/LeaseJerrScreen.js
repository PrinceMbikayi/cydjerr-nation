...
const LeaseJerrScreen = () => {
  ...
  const renderVehicleCard = ({ item, index }) => (
    ...
    >
      <BlurView intensity={20} style={styles.vehicleCardBlur}>
  ...
  const renderFilterPill = ({ item }) => (
    ...
    >
      <BlurView intensity={item.active ? 30 : 15} style={styles.filterPillBlur}>
        <Text style={[
        ...
        <BlurView intensity={20} style={styles.headerBlur}>
          <View style={styles.headerContent}>
            ...
            <TouchableOpacity style={styles.searchButton}>
              <BlurView intensity={15} style={styles.searchButtonBlur}>
      ...
      >
        ...
        <View style={styles.searchSection}>
          <View style={styles.searchContainer}>
            <BlurView intensity={15} style={styles.searchInputBlur}>
        ...
        <View style={styles.quickOptionsSection}>
          ...
          <View style={styles.quickOptionsGrid}>
            <TouchableOpacity style={styles.quickOptionCard}>
              ...
              >
                <BlurView intensity={10} style={styles.quickOptionBlur}>
        ...
        <View style={styles.statsSection}>
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              <BlurView intensity={15} style={styles.statCardBlur}>
        ...
        <View style={styles.specialOfferSection}>
          <TouchableOpacity style={styles.specialOfferCard}>
            ...
            >
              <BlurView intensity={10} style={styles.specialOfferBlur}>
                ...
                <TouchableOpacity style={styles.specialOfferButton}>
                  <BlurView intensity={20} style={styles.specialOfferButtonBlur}>
