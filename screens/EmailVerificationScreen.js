        ...
        <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
          ...
          {!isVerified && (
            <>
              ...
              <View style={styles.codeContainer}>
                ...
                <View style={styles.codeInputsContainer}>
                  {verificationCode.map((digit, index) => (
                    <BlurView key={index} intensity={focusedIndex === index ? 30 : 20} tint="light" style={styles.codeInputBlur}>
                      <TextInput
              ...
              >
                <BlurView intensity={30} tint="light" style={styles.resendButtonBlur}>
                  {isLoading ? (
