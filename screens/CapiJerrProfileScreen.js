...
const CapiJerrProfileScreen = ({ navigation }) => {
  ...
  const renderAccountCard = () => (
    <View style={styles.accountCard}>
      <BlurView intensity={15} style={styles.accountCardBlur}>
  ...
  const renderActionButtons = () => (
    <View style={styles.actionsSection}>
      ...
      <TouchableOpacity 
        ...
        activeOpacity={0.8}
      >
        <BlurView intensity={15} style={styles.secondaryActionBlur}>
      ...
      <TouchableOpacity 
        ...
        activeOpacity={0.8}
      >
        <BlurView intensity={15} style={styles.supportButtonBlur}>
