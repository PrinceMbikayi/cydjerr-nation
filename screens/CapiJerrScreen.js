  ...
  const renderStatCard = (stat) => {
    ...
    return (
      <View key={stat.id} style={styles.statCard}>
        <BlurView intensity={15} style={styles.statCardContent}>
  ...
  const renderPlanCard = (plan) => {
    ...
    return (
      ...
      >
        ...
        >
          <BlurView intensity={20} style={styles.planCardBlur}>
      ...
      >
        ...
        <View style={styles.cryptoActionsContainer}>
          <TouchableOpacity style={styles.cryptoAction} onPress={() => setShowQRModal(true)}>
            <BlurView intensity={20} style={styles.cryptoActionBlur}>
        ...
        {wallet?.solana && (
          <View style={styles.solanaSection}>
            ...
            <View style={styles.walletCard}>
              <BlurView intensity={20} style={styles.walletCardBlur}>
          ...
          <View style={styles.solanaSection}>
            ...
            {solanaBalances.wallets.map((wallet, index) => (
              <View key={index} style={styles.walletCard}>
                <BlurView intensity={15} style={styles.walletCardBlur}>
                  <View style={styles.walletCardContent}>
                    <View style={styles.walletHeader}>
