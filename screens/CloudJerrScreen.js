...
const CloudJerrScreen = () => {
  ...
  const renderHeader = () => (
    <BlurView intensity={20} style={[styles.header, { paddingTop: insets.top + 10 }]}>
      <TouchableOpacity
  ...
  const renderStorageQuota = () => (
    <BlurView intensity={10} style={styles.storageQuotaContainer}>
    ...
    <View style={styles.quickActionsContainer}>
      <View style={styles.quickActionsGrid}>
        ...
        <TouchableOpacity style={styles.quickActionButton} activeOpacity={0.8} onPress={navigateToMyDrive}>
          <BlurView intensity={10} style={styles.actionBlur}>
