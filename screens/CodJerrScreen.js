...
const CodJerrScreen = () => {
  ...
  const renderHeader = () => (
    <View style={styles.header}>
      ...
      <TouchableOpacity style={styles.searchButton}>
        <BlurView intensity={20} style={styles.searchButtonBlur}>
  ...
  const renderSearchAndFilters = () => (
    <View style={styles.searchSection}>
      <BlurView intensity={15} style={styles.searchBar}>
      ...
      >
        {filterTags.map((tag) => (
          ...
          >
            <BlurView intensity={activeFilter === tag ? 25 : 15} style={styles.tagBlur}>
              <Text style={[
                styles.tagText,
  ...
  const renderProjectCard = ({ item }) => (
    <BlurView intensity={15} style={styles.projectCard}>
  ...
  const renderDeveloperCard = ({ item }) => (
    <BlurView intensity={15} style={styles.developerCard}>
      <LinearGradient
