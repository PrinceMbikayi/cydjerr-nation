      ...
      >
        ...
        >
          ...
          <View style={styles.heroSection}>
            ...
            <View style={styles.searchContainer}>
              <BlurView intensity={15} style={styles.searchField}>
            ...
            <View style={styles.specialtiesGrid}>
              {specialties.map((specialty) => (
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <BlurView intensity={10} style={styles.specialtyCardContent}>
                    <MaterialCommunityIcons
                      name={specialty.icon}
                      size={32}
                      color="#4FC3F7"
          ...
          <View style={styles.section}>
            ...
            {doctors.map((doctor) => (
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <BlurView intensity={10} style={styles.doctorCardContent}>
        ...
        <View style={styles.floatingButtons}>
          <TouchableOpacity style={styles.floatingButton}>
            <BlurView intensity={20} style={styles.floatingButtonContent}>
