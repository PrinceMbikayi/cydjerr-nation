...
const JoyJerrScreen = ({ navigation }) => {
  ...
  const renderPost = ({ item }) => {
    ...
    return (
      <View style={styles.postCard}>
        <BlurView intensity={20} style={styles.postBlur}>
          {/* Header du post */}
  ...
  const renderGroupItem = ({ item }) => (
    <TouchableOpacity style={styles.groupCard}>
      <BlurView intensity={20} style={styles.groupBlur}>
  ...
  const renderConversationItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity style={styles.conversationCard}>
        <BlurView intensity={20} style={styles.conversationBlur}>
  ...
  return (
    ...
    >
      ...
      <View style={styles.tabNavigation}>
        <BlurView intensity={20} style={styles.tabBlur}>
          <ScrollView
            horizontal
      ...
      >
        ...
        <View style={styles.newPostContainer}>
          <BlurView intensity={20} style={styles.newPostBlur}>
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            <BlurView intensity={80} style={styles.commentsModal}>
              {/* En-tête du modal */}
