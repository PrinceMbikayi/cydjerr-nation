      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.content}>
            <BlurView intensity={20} style={styles.errorContainer}>
              ...
              <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity
                  ...
                  activeOpacity={0.8}
                >
                  <BlurView intensity={15} style={styles.secondaryButtonBlur}>
...
export const NetworkErrorHandler = ({ error, onRetry, onDismiss }) => {
  ...
  return (
    <View style={styles.networkErrorContainer}>
      <BlurView intensity={15} style={styles.networkErrorBlur}>
